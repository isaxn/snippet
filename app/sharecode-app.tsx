  ...
  return <main>
    <header className="topbar">
      ...
      <div className="account">
        {user ? <><span className="userPill">{user.name.charAt(0).toUpperCase()} <b>{user.name.split(" ")[0]}</b></span><a className="ghost small" href="/signout-with-chatgpt?return_to=%2F">Keluar</a></> : <a className="ghost" href="/signin-with-chatgpt?return_to=%2F">Masuk / Buat akun</a>}
        <button className="primary" onClick={() => user ? setUploading(true) : window.location.href = "/signin-with-chatgpt?return_to=%2F"}>+ Upload kode</button>
      </div>
    </header>
    ...
    <section className="hero">
      <div className="heroCopy">
        ...
        <div className="heroActions"><button className="primary large" onClick={() => user ? setUploading(true) : window.location.href = "/signin-with-chatgpt?return_to=%2F"}>Bagikan kode kamu →</button><a className="textLink" href="#jelajah">Jelajahi snippet ↓</a></div>
